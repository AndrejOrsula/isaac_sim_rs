...
DEFAULT_REPOSITORY_NAME="isaac_sim_rs"
...
CUSTOM_VOLUMES=(
    ...
    # Omniverse / Isaac Sim
    "${HOME}/.nvidia-omniverse/docker/cache/computecache:/root/.nv/ComputeCache"
    "${HOME}/.nvidia-omniverse/docker/cache/glcache:/root/.cache/nvidia/GLCache"
    "${HOME}/.nvidia-omniverse/docker/cache/kit:/root/isaac_sim/kit/cache"
    "${HOME}/.nvidia-omniverse/docker/cache/ov:/root/.cache/ov"
    "${HOME}/.nvidia-omniverse/docker/cache/pip:/root/.cache/pip"
    "${HOME}/.nvidia-omniverse/docker/data:/root/.local/share/ov/data"
    "${HOME}/.nvidia-omniverse/docker/documents:/root/Documents"
    "${HOME}/.nvidia-omniverse/docker/logs:/root/.nvidia-omniverse/logs"
)
